...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "서비스 소개 | AIfind.kr" },
      { name: "description", content: "AIfind.kr은 AI사용자를 위한 AI 도구 검색·비교·활용 플랫폼입니다." },
      { property: "og:title", content: "서비스 소개 | AIfind.kr" },
  ...
  component: () => (
    <>
      <PageHeader
        eyebrow="서비스 소개"
        title="AIfind.kr 소개"
        description="AI 사용자를 위한 AI 도구 검색·비교·활용 플랫폼입니다."
      />
      <div className="mx-auto max-w-3xl space-y-8 px-4 py-10 text-sm leading-relaxed text-foreground/85">
        <section>
          ...
          <p className="mt-3">
            ...
            AIfind.kr은 AI 도구를 이름이 아니라 하려는 일 기준으로 찾을 수 있게 정리합니다.
          </p>
        </section>
        <section>
          <h2 className="text-lg font-extrabold text-foreground">무엇이 다른가요?</h2>
          <ul className="mt-3 space-y-2">
            <li>· AI 사용자 관점의 설명과 활용 사례</li>
        ...
        <section>
          ...
          <p className="mt-3">
            AIfind.kr은 사용자 수, 점유율, 순위, 후기 등 확인되지 않은 수치를 만들어 내지 않습니다. 실제 데이터가
